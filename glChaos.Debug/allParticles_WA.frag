...
// Commenting both lines the error appears.
// Commenting just one of the two, or neither, the compilation is successful.
//
// #define DISABLE_SUB_GROUP_1
// #define DISABLE_SUB_GROUP_2
...
#if !defined(GL_ES) && !defined(DISABLE_SUB_GROUP_1)
...
#if !defined(DISABLE_SUB_GROUP_1)
...
#if !defined(GL_ES) && !defined(DISABLE_SUB_GROUP_2)
...
#if !defined(DISABLE_SUB_GROUP_2)
